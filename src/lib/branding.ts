...
export const BRAND_MANIFESTO =
  "꿈의 결말은 금기였습니다.\n혼자 해석하면 끝났고, 아무도 한 달 뒤를 말해주지 않았습니다.\n우리는 그 영역을 열었습니다.";

export const BRAND_CLOSING = "오늘도,\n누군가의 한 달 뒤가 잠금 해제됩니다.";
...
export const CTA_SIGNUP = "로그인 · 가입하기";
export const CTA_SIGNUP_SEE_MORE = "로그인하고 더 보기";
export const CTA_AUTH_GOOGLE = "Google로 계속하기";
export const CTA_AUTH_EMAIL_LOGIN = "이메일 로그인";
export const CTA_AUTH_EMAIL_SIGNUP = "이메일 가입";
