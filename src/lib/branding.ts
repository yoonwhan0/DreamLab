...
export const BRAND_DEPTH_LINE =
  "해몽은 여기까지입니다. 그다음은 실제 기록으로 천천히 확인합니다.";

/** 핵심 정체성 */
export const BRAND_MANIFESTO =
  "꿈은 보통 해몽에서 끝났습니다.\n하지만 한 달 뒤 실제로 무엇이 달라졌는지는 거의 기록되지 않았습니다.\n우리는 그 빈칸을 모읍니다.";

export const BRAND_CLOSING = "오늘도,\n누군가의 한 달 뒤 기록이 하나 더 쌓입니다.";

export const RESEARCH_MISSION_TITLE = "우리는 어떤 것을 연구하는가";

/** 아코디언 펼침 — 히어로 직후 훅 (태그라인과 겹치지 않게) */
export const RESEARCH_MISSION_HOOK =
  "해몽은 이제 어디서나 받을 수 있습니다.\n문제는 그다음이었습니다.";

/** 내러티브 비트 */
export const RESEARCH_MISSION_BEATS = [
  "AI가 꿈 해몽을 해주는 건,\n더 이상 특별하지 않습니다.",
  "그런데 그 기록은 쌓입니다.\n웃고 넘기기엔, 너무 진지해지고 있습니다.",
  "그래서 우리는 물었습니다.\n한 달 뒤, 그들에게는 무슨 일이 있었을까.",
] as const;
...
export const RESEARCH_MISSION_TOPICS = [
  {
    title: "같은 꿈 → 30일 뒤",
    body: "해몽이 끝나는 지점에서,\n실제로 한 달 뒤 어떤 일이 있었는지를 모읍니다.",
  },
  {
    title: "누적된 꿈 패턴",
    body: "기록이 쌓일수록\n키워드·감정·결말이 아카이브 그래프로 드러납니다.",
  },
  {
    title: "해몽 vs 현실",
    body: "인터넷 해몽과 실제 후기가 얼마나 다른지 —\n겹쳐 비교합니다.",
  },
  {
    title: "익명 후기 네트워크",
    body: "비슷한 꿈을 꾼 사람들의 30일 답변이,\n다음 관측의 통계가 됩니다.",
  },
] as const;
...
export const BRAND_META_DESCRIPTION =
  "DreamLab — 같은 꿈을 꾼 사람들. 30일 뒤, 그들에게는 무슨 일이 있었을까요? 해몽 너머, 한 달 뒤 실제 기록을 모읍니다.";

/** 버튼·퍼널 — 짧고 직관적으로 (브랜드 수식어 X) */
export const CTA_SIGNUP = "Google로 가입하기";
export const CTA_SIGNUP_SEE_MORE = "Google 가입하고 더 보기";
export const CTA_AUTH_GOOGLE = "Google로 계속하기";
