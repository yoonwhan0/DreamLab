...
const PACKS: Record<string, KeywordNarrativePack> = {
  내태몽: {
    ...
    afterByOutcome: {
      nothing: [
        "30일이 지나도 큰 변화는 없었어요. 다만 내태몽 장면이 자주 떠올라 가족과 다시 이야기 나눴습니다.",
        "별일 없이 지나갔지만, 꿈 이후로 보살·연꽃 해몽을 찾아본 기록은 남아 있어요.",
      ],
      good: [
  ...
  보살: {
    ...
    afterByOutcome: {
      nothing: [
        "30일이 지나 특별한 일은 없었어요. 그래도 꿈 장면은 자주 떠올랐습니다.",
      ],
      good: [
  ...
  시험: {
    ...
    afterByOutcome: {
      nothing: [
        "30일이 지나도 시험 결과는 예상 범위 안이었어요. 꿈의 공포와 달리, 현실은 무난히 지나갔습니다. 그래도 '왜 그날밤만 그렇게 무서웠지' 하는 기억은 남아요.",
        "별일 없이 시즌이 끝났습니다. 돌아보니 꿈은 불안의 잔상이었고, 몸은 이미 그걸 버티고 있었어요.",
      ],
      bad: [
  ...
  로또: {
    ...
    afterByOutcome: {
      nothing: [
        "30일이 지나도 재정적으로 큰 변화는 없었어요. 꿈의 설렘은 금방 가라앉았고, 일상은 그대로였습니다.",
        "당첨은 없었지만, 꿈 이후로 '한 방'에 기대하지 않기로 했어요. 마음이 조금 편해졌습니다.",
      ],
      good: [
  ...
  돈: {
    ...
    afterByOutcome: {
      nothing: [
        "30일이 지나도 재정적으로 큰 사건은 없었어요. 꿈의 공포만 남았고, 통장은 조용했습니다.",
      ],
      money: [
  ...
  "전 남친": {
    ...
    afterByOutcome: {
      nothing: [
        "30일이 지나도 연락은 없었어요. 꿈의 그리움만 남았고, 현실은 조용히 흘렀습니다.",
      ],
      love: [
  ...
  "죽은 사람": {
    ...
    afterByOutcome: {
      nothing: [
        "30일이 지나도 특별한 사건은 없었어요. 꿈의 그리움만 남았고, 마음은 조금 정리됐습니다.",
      ],
      family: [
  ...
  불: {
    ...
    afterByOutcome: {
      nothing: [
        "30일이 지나도 큰 사고는 없었어요. 꿈의 공포와 달리, 현실은 조용했습니다.",
      ],
      bad: [
  ...
  이별: {
    ...
    afterByOutcome: {
      ...
      nothing: [
        "30일이 지나도 관계에 큰 변화는 없었어요. 꿈의 불안만 남았습니다.",
      ],
    },
  },
  임신: {
    ...
    afterByOutcome: {
      nothing: [
        "30일이 지나도 관련 소식은 없었어요. 꿈의 긴장만 남았습니다.",
      ],
      family: [
  ...
  "치아 빠짐": {
    ...
    afterByOutcome: {
      nothing: [
        "30일이 지나도 건강상 큰 일은 없었어요. 꿈의 공포만 남았습니다.",
      ],
      health: [
  ...
  "쫓기는 꿈": {
    ...
    afterByOutcome: {
      nothing: [
        "30일이 지나도 큰 사건은 없었어요. 꿈의 공포와 달리 현실은 조용했습니다.",
      ],
      bad: [
  ...
  실직: {
    ...
    afterByOutcome: {
      nothing: [
        "30일이 지나도 직장은 유지됐어요. 꿈의 공포와 달리, 현실은 조용했습니다.",
      ],
      bad: [
