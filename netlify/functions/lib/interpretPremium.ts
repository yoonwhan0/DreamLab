...
- stories에 다른 꿈 내용 복붙·템플릿 ("갑자기 나타났어요", "집에 ○○ 들어온 꿈")
...
## communityEstimate
- stories 5~6개 — **dreamSnippet에 꿈 원문 핵심 장면 1개 이상** 포함 필수
- dreamTitle: 장면 기반 구체 제목 (예: "연꽃 위 보살과 갓난아기", "전쟁 하늘의 내태몽")
- afterStory: 30일 후 — outcomeCategory와 일치, 2~3줄
- totalCount 150~1500, keywords는 꿈 상질 명사
